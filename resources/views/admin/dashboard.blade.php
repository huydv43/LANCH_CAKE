    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="/admins/images/2.png">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="typography.html">Thêm Loại Bánh</a></li>
						<li><a href="glyphicon.html">Thêm Bánh</a></li>
                    </ul>
                </li>
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="typography.html">Thêm Sliders</a></li>
                    </ul>
                </li>
...
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="/admins/js/flot-chart/excanvas.min.js"></script><![endif]-->
